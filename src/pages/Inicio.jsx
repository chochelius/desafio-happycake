        ...
        <div>
            <div class="row ">
                <div className=' col-4 d-none d-sm-block'>
                    {/* <img src="../assets/2.png" alt="logo" className="responsive-img" /> should only show on medium to large devices */}
                    <img src="../assets/2.png" alt="logo-big" className="responsive-img d-none d-sm-block" />
                </div>
